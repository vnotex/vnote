...
//
// Coverage for the `vxpdf://` scheme handler and its shared profile storage.
//
...
void TestVxPdfSchemeHandler::profileStorageStaysUnderConfiguredRoot() {
  QTemporaryDir temp;
...
int main(int argc, char **argv) {
  ...
  QString cachePath;
  {
    ...
    tests::TestVxPdfSchemeHandler test;
