...
QSharedPointer<vte::TextEditorConfig> TextViewWindowController::buildTextEditorConfigFromContent(
    const EditorConfig &p_editorConfig, const TextEditorConfig &p_config,
  ...
  if (!p_themeContent.isEmpty()) {
    editorConfig->m_theme = vte::Theme::createThemeFromContent(p_themeContent);
  }
