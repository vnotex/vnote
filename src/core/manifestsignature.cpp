...
QStringList trustedPublicKeyStrings() {
  return QStringList{
      // TODO(maintainer): paste the base64 body of your minisign .pub here, e.g.
      //   QStringLiteral("RWQf6LRCGA9i53mlYecO4IzT51TGPpvWucNSCh1CBM0QTaLn73Y7GFO3"),
      // and add a second, offline-stored spare key alongside it.
      //
      // Intentionally empty in-tree: a key generated by anyone other than the
      // release maintainer would be worse than useless, because its private
      // half would not be under the maintainer's control.
  };
}
