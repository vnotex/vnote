...
// MarkdownWebGlobalOptions::toJavascriptObject() lives in markdownwebglobaloptions.cpp
// to keep it free of HtmlTemplateHelper's heavy ConfigMgr/ThemeMgr/VNoteX dependencies,
// so core_services consumers (HtmlTemplateService) can link it without dragging in
// the legacy singleton chain.
