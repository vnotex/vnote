...
// CommentService
//
// Owns the per-file plaintext comment sidecar, including for encrypted notes.
// File-type-agnostic; only the note body is encrypted.
//
...
public:
  ...
  // Explicit reload from the ordinary sidecar.
