#ifndef FINDANDREPLACEWIDGET2_H
#define FINDANDREPLACEWIDGET2_H
...
// DI version of FindAndReplaceWidget.
// Uses ServiceLocator instead of legacy singletons for config and theme access.
class FindAndReplaceWidget2 : public QWidget {
  Q_OBJECT
public:
  explicit FindAndReplaceWidget2(ServiceLocator &p_services, QWidget *p_parent = nullptr);
